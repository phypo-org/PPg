...
public class PrototypeWeapon extends PrototypeXmlLoader{
		...
		// Un item peut avoir une action constante ou discrete
		// un point d'action ou une action sur un region ...
		// un item peut etre une arme un bouclier un sort magique ...
		// il peut modifier les attaques les resistance et aussi tout les autres caracteristiques
		// de l'unite !
		// 
		...
		public boolean loadXmlNode(  Node pMotherNode, Node pNode, XmlLoader pXmlLoader ){
				...
				//------------
				 ...
				 cFireTime*=1000; // conversion en milliseconde
