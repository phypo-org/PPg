...
public class PPgGame3d  extends World3d {
    ...
    //    public static PPgGame3d sTheGame = null;
    ...
    //------------------------------------------------
    public  PPgGame3d( DimFloat3 pWorldBox, Engine pEngine, boolean pSmooth ){
        super( pWorldBox, pEngine );

	
        //        PPgGame3d.sTheGame = this;
    ...
    public static void main( String [] args ) {
        ...
        PPgGame3d.sFlagXY = PPgParam.GetBoolean( args, "-XY", false);

        boolean lSmooth = PPgParam.GetBoolean( args, "-t", false);
        PPgGame3d.sViewGrid3d = PPgParam.GetBoolean( args, "-g", true);
        PPgGame3d.sViewRepere = PPgParam.GetBoolean( args, "-r", true);

        PPgGame3d.sGenSize = PPgParam.GetFloat( args, "-s", PPgGame3d.sGenSize);
        System.out.println("Size:" +  PPgGame3d.sGenSize );
        ...
        PPgGame3d lTest = new PPgGame3d( new DimFloat3( 20,  20, 20), lEngine, lSmooth  );

        lTest.setUserControl( new PPgGame3dTest( lTest) );
        lEngine.start( lFps );
    }
}
//*************************************************
