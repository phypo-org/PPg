...
public class PPgXmlTag{
		...
		public final static String TAG_XML_POSITION    = "Position";
		public final static String TAG_XML_SIZE        = "Size";
		public final static String TAG_XML_DEFAULT     = "Default";
		public final static String TAG_XML_QUANTITY    = "Quantity";


		public final static String TAG_XML_PROJECT     = "Project";
		public final static String TAG_XML_CONFIG      = "Config";
		public final static String TAG_XML_PATH        = "Path";
