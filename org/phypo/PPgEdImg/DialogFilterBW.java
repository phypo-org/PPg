...
public class DialogFilterBW extends DialogBase
    ...
    public static  DialogFilterBW sTheDialog = null;


    //------------------------------------------------
    public DialogFilterBW ( EdImgInst pInst ){
    ...
    protected JPanel callInitInterface() {
        ...
        for( int i = 0; i< 3; i++ ){		
            lPanelFact.add( (cSliderFactor[i] = new PPgSliderField( "", 0, 255, (int)cFactPoster[i] , this )));
    ...
    protected void callMakePreview(){			
        cTmpImg =  ImgUtils.FilterRGB2BW( cSavImg, cFactPoster, cOffsetPoster );
        cCanvas.actualize();
    }
    ...
    protected void callButtonOk(){
        ...
        cInst.cGrafCorrect.makeOp( OpGrafCorrect.CorrectCode.FILTER_RGB2BW );
     }
    //---------------------
